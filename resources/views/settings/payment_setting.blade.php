...
@push('title', get_phrase('Payment settings'))
                ...
                <div class="ol-card-body p-4">
                    <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                        ...
                        <div class="tab-content w-100" id="myv-pills-tabContent">
                            ...
                            @foreach ($payment_gateways as $payment_gateway)
                                <div class="tab-pane fade" id="v-pills-{{ $payment_gateway->identifier }}" role="tabpanel" aria-labelledby="v-pills-{{ $payment_gateway->identifier }}-tab" tabindex="0">
