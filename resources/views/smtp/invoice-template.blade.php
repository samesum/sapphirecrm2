...
<head>
    ...
    <title>Invoice | {{get_settings('system_title')}}</title>
</head>
                ...
                <div style="padding: 40px 48px;">
                    ...
                    <div style="margin: 30px 0; border-top: 1px solid #dbdfeb;">
                        <div style="font-weight: 400; font-size: 16px; line-height: 24px; color: #6d718c;">
                            ...
                            <p>
                                {{ get_phrase('Thank you for your purchase! We’ve received your order, we will notify you when it has been sent.') }}
                            </p>
                            <div style="margin: 0;">
                                <div style="display: flex; align-items: center; justify-content: space-between;">
                                    <div>
                                        <h4 style="color: #212534; font-size: 16px; line-height: 16px; font-weight: 600; margin-bottom: 8px;">Order details:</h4>
                                        <p>
                                            {{ get_phrase('No. Invoice:') }} <span>INV/20220403/NTL/75686059</span>
                                        </p>
                                    </div>
                                    <button style="padding: 8px 20px; color: #1b84ff; line-height: 25px; font-weight: 700; font-size: 16px; background: #ffffff; border-radius: 6px; border: 1px solid #1b84ff;">{{ get_phrase('View Transactions') }}</button>
                                </div>
                                <span>
                                    Date: 23 June 2025
                                </span>
                    ...
                    <table style="border-collapse: collapse; width: 100%; border-bottom: 1px solid #dbdfeb;">
                        <thead style=" border-top: 1px solid #dbdfeb;">
                            <tr style="text-align: center;">
                                <th style="padding: 10px 8px 10px 8px;">No.</th>
                                <th style="padding: 10px 8px 10px 8px;">Description</th>
                                <th style="padding: 10px 8px 10px 8px;">Price</th>
                                <th style="padding: 10px 8px 10px 8px;">Total</th>
                            </tr>
                        </thead>
                        <tbody style="border-top: 1px solid #dbdfeb;">
                            <tr style="text-align: center;">
                            ...
                            <tr style="text-align: center;">
                                <td
                                    style="padding: 10px 8px; background-image: linear-gradient(
                          to right,
                          #ddd 40%,
