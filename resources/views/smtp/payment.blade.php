...
<head>
    ...
    <title>Payment | {{get_settings('system_title')}}</title>
</head>
        ...
        <div style="max-width: 640px; width: 100%; margin: 0 auto; background: #ffffff;">
            <div style="padding: 40px 48px;">
                ...
                <div style="font-weight: 500; font-size: 16px; line-height: 24px; color: #212534; ">
                    <p style="margin-bottom: 24px;">This email was sent to <a href="mailto:[site_email]" style="color: #1b84ff;">[site_email]</a>.If you rather not receive this kind of email. Do not want any more emails from Notable?
