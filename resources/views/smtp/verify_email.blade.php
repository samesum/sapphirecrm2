...
<head>
    ...
    <title>Verify email | {{get_settings('system_title')}}</title>
</head>
        ...
        <div style="background: #fafafa;">
            <div style="max-width: 640px; width: 100%; margin: 0 auto; background: #ffffff;">
                <div style="padding: 40px 48px;">
                    ...
                    <div style="border-top: 1px solid #dbdfeb; margin-bottom: 0;">
                        <h1 style="margin: 30px 0 24px 0; font-weight: 600; font-size: 24px; line-height: 24px; color: #212534;">{{ get_phrase('Confirm Verification Code') }}</h1>
                        <div style="font-weight: 400; font-size: 16px; line-height: 24px; color: #6d718c; ">
                            <p>Hi [client_name],</p>
                            <p style="margin: 24px 0">This is your verification code:</p>
                            <p style="margin: 0; color: #212534; line-height: 48px; font-weight: 600; font-size: 48px;">44500
                            </p>
                            <p style="margin-bottom: 24px;">
                                Whether you`re here for your brand, for a cause, or just fun welcome!
                            </p>
                            <p style="margin: 0;">
                                This code will only be valid for the next 5 minutes.If the does not work , you can use this login verification link:
                            </p>
                        </div>
                        <a href="" style="display: inline-block; background: #1b84ff; text-decoration: none; font-weight: 600; border-radius: 6px; color: #ffffff; font-size: 14px; padding: 19px 45px; margin-top: 24px;">Verify Email</a>
                    </div>
                    <div style="font-weight: 500; font-size: 16px; line-height: 24px; color: #212534; margin-top: 0;">
                        <p style="margin: 24px 0;">
                            This email was sent to <a href="#" style="color: #1b84ff;">{{get_settings('system_email')}}</a>. If you`d rather not receive this kind of email.Don`t want any more emails from Notable?       <a href="#" style="color: #1b84ff;">Unsubscribe</a>.
                        </p>
                        <p style="margin: 0;">
