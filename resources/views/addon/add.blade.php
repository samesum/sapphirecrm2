<div class="ol-card mt-3">
    <div class="ol-card-body">
        <form action="{{ route(get_current_user_role() . '.addon.store') }}" method="post" id="ajaxForm" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="fpb7 mb-2">
                        <button type="submit" class="btn mt-3 ol-btn-primary">{{ get_phrase('Submit') }}</button>
                    </div>
                </div>
            </div>
        </form>
