...
<form action="#" class="form paystack-form">
    ...
    <button type="button" name="pay_now" id="pay-now" class="btn btn-primary py-2 px-3" onclick="payWithPaystack()">{{get_phrase('pay by paystack')}} <span data-toggle="tooltip" title="Paystack Payment" class="premium-icon"><i class="fas fa-chess-queen"></i></span></button>
</form>
@php
