...
<div class="ol-card">
    <div class="ol-card-body p-3 position-relative" id="filters-container">
                ...
                <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                    <div class="top-bar d-flex align-items-center w-100 flex-wrap">
                        ...
                        <div class="btn-group custom-dropdown" id="export-btn1">
                            <button class="btn ol-btn-light btn-squire" type="button" data-bs-toggle="tooltip" title="{{ get_phrase('Filter') }}" id="" onclick="rightCanvas('{{ route(get_current_user_role() . '.filter', ['param' => 'project']) }}', '{{ get_phrase('Filter project') }}', 'right', '#filter-section')">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        @if (has_permission('project.create'))
                            <button onclick="rightCanvas('{{ route(get_current_user_role() . '.project.create') }}', 'Create project')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px enable-no-data-action">
        ...
        <div id="grid-list" class="row grid-list g-3 mt-2">
            @include('projects.ajax_grid')
        </div>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            contextMenuInitialize('.grid-card');
        });
