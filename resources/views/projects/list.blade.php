                ...
                <div class="ol-card-body p-3 position-relative" id="filters-container">
                                ...
                                <div class="top-bar flex-wrap d-flex align-items-center w-100">
                                    ...
                                    <div class="custom-dropdown" id="export-btn1">
                                        ...
                                        <ul class="dropdown-list dropdown-export">
                                            <li class="mb-1">
                                                <a class="dropdown-item export-btn" onclick="exportFile('{{ route(get_current_user_role() . '.project.export-file', ['file' => 'pdf']) }}')" href="javascript:void(0)">
                                            ...
                                            <li class="mb-1">
                                                <a class="dropdown-item export-btn" href="javascript:void(0)" onclick="exportFile('{{ route(get_current_user_role() . '.project.export-file', ['file' => 'csv']) }}')">
                                            ...
                                            <li>
                                                <a class="dropdown-item export-btn" href="javascript:void(0)" onclick="exportFile('{{ route(get_current_user_role() . '.project.export-file', ['file' => 'print']) }}')">
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="btn-group custom-dropdown" id="export-btn1">
                                        <button class="btn ol-btn-light btn-squire" type="button" id="" onclick="rightCanvas('{{ route(get_current_user_role() . '.filter', ['param' => 'project']) }}', '{{ get_phrase('Filter project') }}', 'right', '#filter-section')" data-bs-toggle="tooltip" data-bs-toggle="tooltip" title="{{ get_phrase('Filter') }}">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <a href="{{ route(get_current_user_role() . '.projects', ['layout' => 'grid']) }}" class="grid-icon ms-auto {{ request('layout') === 'grid' ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ get_phrase('Grid View') }}">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M15.4165 2.9165H12.9165C11.8573 2.9165 11.2498 3.524 11.2498 4.58317V7.08317C11.2498 8.14234 11.8573 8.74984 12.9165 8.74984H15.4165C16.4757 8.74984 17.0832 8.14234 17.0832 7.08317V4.58317C17.0832 3.524 16.4757 2.9165 15.4165 2.9165ZM16.2498 7.08317C16.2498 7.68317 16.0165 7.9165 15.4165 7.9165H12.9165C12.3165 7.9165 12.0832 7.68317 12.0832 7.08317V4.58317C12.0832 3.98317 12.3165 3.74984 12.9165 3.74984H15.4165C16.0165 3.74984 16.2498 3.98317 16.2498 4.58317V7.08317ZM7.08317 2.9165H4.58317C3.524 2.9165 2.9165 3.524 2.9165 4.58317V7.08317C2.9165 8.14234 3.524 8.74984 4.58317 8.74984H7.08317C8.14234 8.74984 8.74984 8.14234 8.74984 7.08317V4.58317C8.74984 3.524 8.14234 2.9165 7.08317 2.9165ZM7.9165 7.08317C7.9165 7.68317 7.68317 7.9165 7.08317 7.9165H4.58317C3.98317 7.9165 3.74984 7.68317 3.74984 7.08317V4.58317C3.74984 3.98317 3.98317 3.74984 4.58317 3.74984H7.08317C7.68317 3.74984 7.9165 3.98317 7.9165 4.58317V7.08317ZM15.4165 11.2498H12.9165C11.8573 11.2498 11.2498 11.8573 11.2498 12.9165V15.4165C11.2498 16.4757 11.8573 17.0832 12.9165 17.0832H15.4165C16.4757 17.0832 17.0832 16.4757 17.0832 15.4165V12.9165C17.0832 11.8573 16.4757 11.2498 15.4165 11.2498ZM16.2498 15.4165C16.2498 16.0165 16.0165 16.2498 15.4165 16.2498H12.9165C12.3165 16.2498 12.0832 16.0165 12.0832 15.4165V12.9165C12.0832 12.3165 12.3165 12.0832 12.9165 12.0832H15.4165C16.0165 12.0832 16.2498 12.3165 16.2498 12.9165V15.4165ZM7.08317 11.2498H4.58317C3.524 11.2498 2.9165 11.8573 2.9165 12.9165V15.4165C2.9165 16.4757 3.524 17.0832 4.58317 17.0832H7.08317C8.14234 17.0832 8.74984 16.4757 8.74984 15.4165V12.9165C8.74984 11.8573 8.14234 11.2498 7.08317 11.2498ZM7.9165 15.4165C7.9165 16.0165 7.68317 16.2498 7.08317 16.2498H4.58317C3.98317 16.2498 3.74984 16.0165 3.74984 15.4165V12.9165C3.74984 12.3165 3.98317 12.0832 4.58317 12.0832H7.08317C7.68317 12.0832 7.9165 12.3165 7.9165 12.9165V15.4165Z"
                                                fill="white" />
                                        </svg>

                                    </a>

                                    <a href="{{ route(get_current_user_role() . '.projects', ['layout' => 'list']) }}" class="grid-icon {{ request('layout') === 'list' || request('layout') == '' ? 'active' : '' }}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ get_phrase('List View') }}">
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M7.91683 4.58317C7.91683 4.35317 8.1035 4.1665 8.3335 4.1665H17.5002C17.7302 4.1665 17.9168 4.35317 17.9168 4.58317C17.9168 4.81317 17.7302 4.99984 17.5002 4.99984H8.3335C8.1035 4.99984 7.91683 4.81317 7.91683 4.58317ZM17.5002 9.58317H8.3335C8.1035 9.58317 7.91683 9.76984 7.91683 9.99984C7.91683 10.2298 8.1035 10.4165 8.3335 10.4165H17.5002C17.7302 10.4165 17.9168 10.2298 17.9168 9.99984C17.9168 9.76984 17.7302 9.58317 17.5002 9.58317ZM17.5002 14.9998H8.3335C8.1035 14.9998 7.91683 15.1865 7.91683 15.4165C7.91683 15.6465 8.1035 15.8332 8.3335 15.8332H17.5002C17.7302 15.8332 17.9168 15.6465 17.9168 15.4165C17.9168 15.1865 17.7302 14.9998 17.5002 14.9998ZM5.41683 4.58317C5.41683 5.50234 4.66933 6.24984 3.75016 6.24984C2.831 6.24984 2.0835 5.50234 2.0835 4.58317C2.0835 3.664 2.831 2.9165 3.75016 2.9165C4.66933 2.9165 5.41683 3.664 5.41683 4.58317ZM4.5835 4.58317C4.5835 4.12317 4.20933 3.74984 3.75016 3.74984C3.291 3.74984 2.91683 4.12317 2.91683 4.58317C2.91683 5.04317 3.291 5.4165 3.75016 5.4165C4.20933 5.4165 4.5835 5.04317 4.5835 4.58317ZM5.41683 9.99984C5.41683 10.919 4.66933 11.6665 3.75016 11.6665C2.831 11.6665 2.0835 10.919 2.0835 9.99984C2.0835 9.08067 2.831 8.33317 3.75016 8.33317C4.66933 8.33317 5.41683 9.08067 5.41683 9.99984ZM4.5835 9.99984C4.5835 9.53984 4.20933 9.1665 3.75016 9.1665C3.291 9.1665 2.91683 9.53984 2.91683 9.99984C2.91683 10.4598 3.291 10.8332 3.75016 10.8332C4.20933 10.8332 4.5835 10.4598 4.5835 9.99984ZM5.41683 15.4165C5.41683 16.3357 4.66933 17.0832 3.75016 17.0832C2.831 17.0832 2.0835 16.3357 2.0835 15.4165C2.0835 14.4973 2.831 13.7498 3.75016 13.7498C4.66933 13.7498 5.41683 14.4973 5.41683 15.4165ZM4.5835 15.4165C4.5835 14.9565 4.20933 14.5832 3.75016 14.5832C3.291 14.5832 2.91683 14.9565 2.91683 15.4165C2.91683 15.8765 3.291 16.2498 3.75016 16.2498C4.20933 16.2498 4.5835 15.8765 4.5835 15.4165Z"
                                                fill="#98A1B7" />
                                        </svg>
                                    </a>

                                    @if (has_permission('project.create'))
                                        <button onclick="rightCanvas('{{ route(get_current_user_role() . '.project.create') }}', '{{ get_phrase('Create project') }}')" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px enable-no-data-action">
                    ...
                    <div class="table-responsive">
                        <table class="table server-side-datatable" id="table_list">
                            ...
                            <tbody>
                                @php
                                    $query = App\Models\Project::limit(10);
                                    if (get_current_user_role() == 'client') {
                                        $query->where('client_id', auth()->user()->id);
                                    } elseif (get_current_user_role() == 'staff') {
                                        $query->whereJsonContains('staffs', (string) auth()->user()->id);
                                    }
                                    $query->orderBy('id', 'desc');
                                @endphp
                                @foreach ($query->get() as $key => $project)
                                    <tr class="hover-action-label">
                                        <td>
                                        ...
                                        <td class="">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="ellipsis-line-1 mx-200px" data-bs-toggle="tooltip" title="{{ $project?->title }}" data-bs-placement="top">{{ $project?->title }}</a>
                                                <a href="{{ route(get_current_user_role() . '.project.details', $project->code) }}" class="btn action-label text-nowrap ms-auto">{{ get_phrase('Open Project') }}</a>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <div class="dropdown disable-right-click ol-icon-dropdown">
                                                ...
                                                <ul class="dropdown-menu contextMenuContainer">
                                                    @php
                                                        ...
                                                        $editRoute = route($role . '.project.edit', $project->code);
                                                        $deleteRoute = route($role . '.project.delete', $project->code);
                                                        $viewRoute = route($role . '.project.details', $project->code);
                                                        $dashboardRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'dashboard']);
                                                        $milestoneRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'milestone']);
                                                        $milestoneRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'milestone']);
                                                        $taskRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'task']);
                                                        $fileRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'file']);
                                                        $meetingRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'meeting']);
                                                        $invoiceRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'invoice']);
                                                        $ganttRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'gantt_chart']);
                                                        $timesheetRoute = route($role . '.project.details', ['code' => $project->code, 'tab' => 'timesheet']);
                                                    @endphp
                                                    @if (has_permission('project.details'))
                                                        @php $options[] = 'project.details'; @endphp
                                                        <li>
                                                    ...
                                                    @if (has_permission('project.delete'))
                                                        @php $options[] = 'project.delete'; @endphp
                                                        <li>
                    ...
                    <div class="d-none d-lg-block custom-datatable-row-selector">
                        <div class="page-length-select fs-12px margin--40px d-flex align-items-center position-absolute">
                            ...
                            <label for="page-length-select" class="ps-2 w-100"> {{ get_phrase('of') }} {{ $projects->total() }}</label>
                        </div>
                    </div>
...
@push('js')
    <script>
        ...
        initiate_floating_actions(
            ...
            "{{ has_permission('project.delete') ? route(get_current_user_role() . '.project.multi-delete', ['type' => 'project']):'' }}", // Delete route
            "{{ route(get_current_user_role() . '.project.export-file', ['file' => 'pdf']) }}", // Export route pdf
            "{{ route(get_current_user_role() . '.project.export-file', ['file' => 'csv']) }}", // Export route csv
            "{{ route(get_current_user_role() . '.project.export-file', ['file' => 'print']) }}", // Export route for print copy
        );

        server_side_datatable('["id","title","code","client","staff","budget","progress","status","options"]',
            "{{ route(get_current_user_role() . '.projects', ['layout' => 'list']) }}", '{{ App\Models\Project::count() }}');
    </script>
@endpush
