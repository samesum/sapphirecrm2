    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center justify-content-lg-end min-height-100vh column-gap-5">
            <div class="col-md-6 col-lg-4 d-flex flex-column justify-content-center align-items-center position-relative pe-xl-5">
                ...
                <form class="auth-form" method="POST" action="{{ route('login') }}" id="ajaxForm">


                    @csrf
                    <h1 class="title text-center fs-36px mb-20px">{{ get_phrase('Log in') }}</h1>
                    ...
                    <div class="mb-30px d-flex align-items-center gap-2 flex-wrap justify-content-between">
                        <div class="form-check form-check-checkbox2">
                            <input class="form-check-input form-check-input-checkbox2" type="checkbox" value="" id="flexCheckDefault">
                            <label class="form-check-label form-check-label-checkbox2" for="flexCheckDefault">
