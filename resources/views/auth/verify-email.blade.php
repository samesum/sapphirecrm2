...
<head>
    ...
    <title>{{get_phrase('Email verification')}} | {{get_settings('system_title')}}</title>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center justify-content-lg-end min-height-100vh column-gap-5">
            <div class="col-md-6 col-lg-4 d-flex flex-column justify-content-center align-items-center position-relative pe-xl-5">
                ...
                <form class="auth-form" method="POST" action="{{ route('verification.send') }}" id="ajaxForm">
                    @csrf
                    <h1 class="title text-center fs-36px mb-20px">{{ get_phrase('Verify Your Email') }}</h1>
