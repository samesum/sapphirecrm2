...
<head>
    ...
    <title>{{get_phrase('Reset Password')}} | {{get_settings('system_title')}}</title>
    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center justify-content-lg-end min-height-100vh column-gap-5">
            <div class="col-md-6 col-lg-4 d-flex flex-column justify-content-center align-items-center position-relative pe-xl-5">
                ...
                <form class="auth-form" method="POST" action="{{ route('password.store') }}" id="ajaxForm">
                    @csrf
                    <h1 class="title text-center fs-36px mb-20px">{{ get_phrase('Create New Password') }}</h1>
                    ...
                    <div class="mb-20px">
                        ...
                        <input type="email" value="{{ urldecode($request->email) }}" class="form-control ol2-form-control" id="email" name="email" placeholder="Your email here">
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="password_confirmation" class="form-label ol2-form-label mb-3">{{ get_phrase('Confirm Password') }} <span class="form-label-required">*</span></label>
                        <div class="password-input-wrap">
                            <input type="password" class="form-control ol2-form-control password-field" id="password_confirmation" name="password_confirmation" placeholder="Min 8 character">
                            <div class="password-toggle-icons">
                                <span class="password-toggle-icon fs-5" toggle=".password-field">
