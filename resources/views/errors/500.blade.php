...
<head>
    ...
    <title>{{ get_phrase('500 error found') }}</title>
            ...
            <div class="d-flex justify-content-center align-items-center vh-100">
                <div>
                    <div class="d-flex justify-content-center mb-20px">
                        <img src="{{ asset('assets/images/500.png') }}" alt="">
                    </div>
                    <h4 class="mb-12px fs-20px lh-20 text-center title">{{ get_phrase('500 server error') }}</h4>
                    <p class="text-center mb-20px sub-title lh-24 fs-16px">{{ get_phrase('A technical error has occurred.') }}</p>
