...
class ZoomMeetingController extends Controller
{
    ...
    {
        $data['clientId']     = "mFgJ4QB0S_ue5YhRrbQ7yg";
        $data['clientSecret'] = "OZ6m9dwejrFoWywAKDGQK1mh3yRyhyl3";
        $data['accountId']    = "RG4XYUQ3RKqu8NetilQ9UA";
        $data['email']        = "ponkojr1998@gmail.com";
        return $data;
    }
}
